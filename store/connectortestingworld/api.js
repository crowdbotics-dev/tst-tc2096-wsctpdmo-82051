...
import { CONNECTORTESTINGWORLD_USERNAME, CONNECTORTESTINGWORLD_PASSWORD } from "react-native-dotenv";
...
function connectortestingworld_get_testing_test_path_cool_read(payload) {
  return connectortestingworld.get(`/testing/${payload.test}/${payload.path}/${payload.cool}`);
}
